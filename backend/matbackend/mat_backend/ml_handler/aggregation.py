...
class Aggregator():
    ...
    def aggregate(self, parameters, client_names):
            ...
            for client in client_names:
                ...
                local_model.load_weights(f"global")
