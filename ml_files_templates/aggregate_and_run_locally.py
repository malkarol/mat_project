...
# number of data trained by each user
local_counts = [4200,4200,4200]
sum_local_counts = sum(local_counts)
# create optimizer
lr = 0.01
...
for client in client_names:
    ...
    scaling_factor = weight_scalling_factor(local_counts[i], sum_local_counts)
